...
Execute unit tests
```
    cd "SSBJr.WebAuth.AWS.Authentication/test/SSBJr.WebAuth.AWS.Authentication.Tests"
    dotnet test
```

Deploy application
```
    cd "SSBJr.WebAuth.AWS.Authentication/src/SSBJr.WebAuth.AWS.Authentication"
